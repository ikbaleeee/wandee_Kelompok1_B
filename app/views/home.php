            ...
            <article class="dest-card" data-category="<?= htmlspecialchars($dest['category']) ?>">
              <div class="dest-thumb">
                ...
                <div class="dest-tags">
                  ...
                  <?php else: ?>
                    <span class="tag tag-full" style="background: rgba(255, 79, 129, 0.15); color: #ff4f81;">Kuota Penuh</span>
                  <?php endif; ?>
                </div>
              </div>
              ...
              <div class="dest-body">
                ...
                <div class="dest-footer">
                  <div class="dest-date">
                    <?= !empty($dest['trip_date']) ? htmlspecialchars($dest['trip_date']) : '-' ?>
                  </div>

                  <div class="dest-price">
                    <span class="per-person">Per Orang</span>
                    <span class="price">Rp <?= number_format((int)$dest['price'], 0, ',', '.') ?></span>
                  </div>
                </div>
              </div>
            </article>
