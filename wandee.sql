...
--
-- Host: localhost:3306
-- Generation Time: May 15, 2026 at 03:07 AM
...
CREATE TABLE `payments` (
  ...
  `payment_status` enum('waiting','verified','rejected') DEFAULT 'waiting',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 'Admin Wandee', 'admin@wandee.com', '0192023a7bbd73250516f069df18b500', 'admin', NULL, '2026-05-15 03:07:19');
